...
def istek_neler_yapiyorsun(metin: str):
    ...
    kaliplar = [
        ...
        "neler yapabilirsin", "ne yapabilirsin", "özelliklerin", "ozelliklerin",
        "komutlar", "yardım", "yardim", "nasıl kullanılır", "nasil kullanilir"
    ]
    return any(k in m for k in kaliplar)
...
def bes_komutu_mu(metin: str):
    m = temizle_metin(metin)
    return any(k in m for k in [
        "bes", "bireysel emeklilik", "emeklilik fon", "emeklilik fonları",
        "bes haber", "bes öneri", "bes oneri", "altın fonu", "altin fonu",
        "hisse fonu", "para piyasası fonu", "para piyasasi fonu"
    ])
...
def main():
    if BOT_TOKEN == "BURAYA_TELEGRAM_BOT_TOKEN_YAZ":
        print("Önce BOT_TOKEN alanına Telegram BotFather tokenini yazmalısın.")
        return
